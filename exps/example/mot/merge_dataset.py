...
class Exp(MyExp):
    def __init__(self):
        ...
        self.carla_path = "carla"
        self.coco_path = "coco"
        self.kitti_path = "kitti"
        self.roboflow_path = "roboflow"
        self.stanford_path = "stanford_cars"
        self.ua_path = "ua-detrac"
    ...
    def get_data_loader(self, batch_size, is_distributed, no_aug=False):
        ...
        carla_dataset = CarlaDataset(
            data_dir=os.path.join(get_yolox_datadir(), self.carla_path),
            name='train',
        ...
        kitti_dataset = KittiDataset(
            data_dir=os.path.join(get_yolox_datadir(), self.kitti_path, "training"),
        ...
        '''
        #Roboflow
        roboflow_dataset = CarlaDataset(
            data_dir=os.path.join(get_yolox_datadir(), self.roboflow_path),
            name='train',
            img_size=self.input_size,
            preproc=TrainTransform(
                rgb_means=(0.485, 0.456, 0.406),
        ...
        #Stanford Cars
        stanford_dataset = CarlaDataset(
            data_dir=os.path.join(get_yolox_datadir(), self.stanford_path),
            name='train',
            img_size=self.input_size,
            preproc=TrainTransform(
                rgb_means=(0.485, 0.456, 0.406),
        ...
        #UA-Detrac
        ua_dataset = UADataset(
            data_dir=os.path.join(get_yolox_datadir(), self.ua_path),
            name='train',
            img_size=self.input_size,
            preproc=TrainTransform(
                rgb_means=(0.485, 0.456, 0.406),
        ...
        '''
        dataset = MergeDataset([ua_dataset],
            img_size=self.input_size, 
            preproc=TrainTransform(
                rgb_means=(0.485, 0.456, 0.406),
                std=(0.229, 0.224, 0.225),
    ...
    def get_eval_dataset(self):
        from yolox.data import KittiDataset, ValTransform, UADataset
